...
class WSHandler(tornado.websocket.WebSocketHandler):
	...
	def on_message(self, message):      # receives the data from the webpage and is stored in the variable message
		...
		inputs['key'].append(c)
		inputs['time'].append(time_)

		if c == '8' :
		  print "Running Forward"
		  BP.set_motor_power(BP.PORT_B, -100)  #Set the speed of MotorA (-255 to 255)
		  BP.set_motor_power(BP.PORT_C, -100)  #Set the speed of MotorD (-255 to 255)
